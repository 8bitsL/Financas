...
const Ganhos = () => {
	...
	const [dadosParaEditarLabel, setDadosParaEditarLabel] = useState({
		open: false,
		tipo: '',
		labelAtual: '',
		indexAtual: '',
	...
	const [dadosParaAddInput, setDadosParaAddInput] = useState({
		open: false,
		label: '',
		valor: '',
		id: ''
	...
	const [dadosParaDeletarInput, setDadosParaDeletarInput] = useState({
		open: false,
		label: '',
		id: ''
	})
	...
	const handleValores = (event, index) => {
		...
		console.log(updatedValores[index])
		updatedValores[index].valor = newValue;
	...
	useEffect(() => {
		pegaInputsGanhos().then((response) => {

			const dados = response.data;
			const retiraMes = dados.map((dado) => ({
				id: dado.id,
				label: dado.label,
				valor: dado.valor
			}))
			console.log(retiraMes)
